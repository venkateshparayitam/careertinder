 ...
 */
class PowerSaveModeDelegate implements com.softwaregiants.careertinder.customViews.circularProgressBar.PBDelegate {
  ...
  PowerSaveModeDelegate(@NonNull com.softwaregiants.careertinder.customViews.circularProgressBar.CircularProgressDrawable parent) {
    mParent = parent;
  }
